    ...
    <div className="App">
      <div className='calculator-grid'>
        <div className='output'>
          ...
          <div className='current-operant'>{result ? result : !currentOperation ? number1 : number2}</div>
        </div>
        <div className='tools'></div>
        <RedButton>C</RedButton>
        <GreenButton onClick={() => clickOperation("resolver")}>()</GreenButton>
        ...
        <Button >.</Button>
        <IqualButton onclick={getResult}>=</IqualButton>
      </div>
    </div>   
  )
}
